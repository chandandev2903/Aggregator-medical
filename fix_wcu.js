...
console.log('Line 3109:', lines[3108].trim().substring(0, 60));
console.log('Line 3335:', lines[3334].trim().substring(0, 60));

// New banner block (lines 3109-3335 → indices 3108-3334 inclusive)
const newBanner = `    <!-- Why Patients Choose Us -->
    <section id="why-choose-us" class="overflow-hidden">
      ...
      <div id="wcu-banner">
        ...
        <div class="relative z-10 flex flex-col lg:flex-row items-stretch w-full" style="min-height:295px;">
          ...
          <!-- ① LEFT: 2x3 Image Grid — matches Image 1 left panel exactly -->
          ...
          <!-- ② CENTER: 24h ring badge + WHY CHOOSE US? + 4 centred pill buttons + phone CTA -->
          <div class="flex flex-col justify-center py-7 lg:py-5 px-6 lg:px-8" style="flex:0 0 auto;width:min(100%,390px);">
            ...
            <div class="flex items-center gap-4 mb-5">
              <div class="wcu-ring">
                <div class="text-center z-10 leading-none" style="position:relative;">
                  ...
                  <span class="font-bold uppercase" style="font-size:0.44rem;letter-spacing:0.12em;color:rgba(255,255,255,0.7);">h</span>
                </div>
            ...
            <div class="mt-6 flex items-center gap-3">
              ...
              <div>
                <p style="color:rgba(255,255,255,0.55);font-weight:700;text-transform:uppercase;font-size:0.58rem;letter-spacing:0.1em;margin:0 0 1px;">Call To Find Us</p>
          ...
          <div class="hidden xl:block relative shrink-0 self-stretch overflow-hidden" style="flex:1;max-width:230px;">
            <img
          ...
          <!-- ④ RIGHT: IQH branding — mirrors "Savitri Trust Care Hospital" big-text panel in Image 1 -->
          <div class="hidden xl:flex flex-col justify-center py-8 shrink-0" style="width:300px;padding-left:0.75rem;padding-right:2.5rem;background:linear-gradient(to left,rgba(5,165,195,0.5) 0%,transparent 100%);">
            ...
            <p style="color:rgba(255,255,255,0.65);line-height:1.6;font-size:0.77rem;max-width:240px;">
...
// Replace indices 3108 through 3334 (lines 3109-3335) with new banner
const newLines = [...lines.slice(0, 3108), newBanner, ...lines.slice(3335)];
...
console.log('New total lines:', verify.length);
console.log('New line 3109:', verify[3108].trim().substring(0, 70));
console.log('SUCCESS!');
